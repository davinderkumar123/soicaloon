...
import com.app.socilon.databinding.FragmentAddPhotosBinding;


public class AddPhotosFragment extends Fragment {
    FragmentAddPhotosBinding addPhotosBinding;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        addPhotosBinding=FragmentAddPhotosBinding.inflate(getLayoutInflater());
        return  addPhotosBinding.getRoot();
    }
    ...
    private void onClicks(View view) {
        addPhotosBinding.backbtn.setOnClickListener(view1 -> {
            getActivity().onBackPressed();
        });
        addPhotosBinding.goToVideos.setOnClickListener(view1 -> {
            Navigation.findNavController(getActivity(),R.id.fragment_container_view).navigate(R.id.addVideosFragment);
        });
        addPhotosBinding.updatePhotoBtn.setOnClickListener(view1 -> {
           showDailog();
        });
    ...
    private void setAdapter(View view) {
        ...
        addPhotosBinding.photosRecyclar.setAdapter(photoListAdapter);
    }
}